...
public class PageMaker {
	...
	private int startPage = 1;	// 시작 페이지 번호 (1,11,21)
	private int endPage = 1; // 마지막 페이지 번호 (10,20,30)
	private int realEndPage; // 끝 페이지 번호 (총 20페이면 20)
	private boolean prev;	// 이전페이지 버튼 유뮤
